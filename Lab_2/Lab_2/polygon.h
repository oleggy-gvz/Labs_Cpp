...
class CPolygon
{
	...
	bool CheckConvex(int n, POINT *v); // проверяет многоугольник на выпуклость
	bool CheckExist(int n, POINT *v); // проверяет возможность отображения многоугольника
...
public:
	...
	void SetVertex(int n, POINT v); // установка координат POINT для n-ой вершины
